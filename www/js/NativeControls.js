...
{
    Cordova.exec("NativeControls.createNavBar");
};
...
{
    Cordova.exec("NativeControls.setupLeftNavButton", title, imageURL, onselect);
};

NativeControls.prototype.hideLeftNavButton = function() 
{
    Cordova.exec("NativeControls.hideLeftNavButton");
};

NativeControls.prototype.showLeftNavButton = function() 
{
    Cordova.exec("NativeControls.showLeftNavButton");
};
...
{
    Cordova.exec("NativeControls.setupRightNavButton", title, imageURL, onselect);
};


NativeControls.prototype.hideRightNavButton = function() 
{
    Cordova.exec("NativeControls.hideRightNavButton");
};

NativeControls.prototype.showRightNavButton = function() 
{
    Cordova.exec("NativeControls.showRightNavButton");
};
...
{
    Cordova.exec("NativeControls.setNavBarTitle", title);
};
...
{
    Cordova.exec("NativeControls.setNavBarLogo", imageURL);
};
...
NativeControls.prototype.showNavBar = function() {
    Cordova.exec("NativeControls.showNavBar");
};
...
NativeControls.prototype.hideNavBar = function() {
    ...
    Cordova.exec("NativeControls.hideNavBar");
};
